                ...
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="card shadow mb-4">
                            ...
                            <div
                                ...
                                <div className="dropdown no-arrow">
                                    <a className="dropdown-toggle" href="/card" role="button" id="dropdownMenuLink"
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                        ...
                                        <a className="dropdown-item" href="/card">Action</a>
                                        <a className="dropdown-item" href="/card">Another action</a>
                                        <div className="dropdown-divider"></div>
                                        <a className="dropdown-item" href="/card">Something else here</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="card shadow mb-4">
                            ...
                            <a href="/cardcollapseCardExample" className="d-block card-header py-3" data-toggle="collapse"
