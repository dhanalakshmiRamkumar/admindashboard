            ...
            <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown no-arrow d-sm-none">
                        <a className="nav-link dropdown-toggle" href="/other" id="searchDropdown" role="button"
                    ...
                    <li className="nav-item dropdown no-arrow mx-1">
                        <a className="nav-link dropdown-toggle" href="/other" id="alertsDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a className="dropdown-item d-flex align-items-center" href="/other">
                                <div className="mr-3">
                            ...
                            <a className="dropdown-item text-center small text-gray-500" href="/other">Show All Alerts</a>
                        </div>
                    </li>

                    
                    <li className="nav-item dropdown no-arrow mx-1">
                        <a className="nav-link dropdown-toggle" href="/other" id="messagesDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a className="dropdown-item text-center small text-gray-500" href="/other">Read More Messages</a>
                        </div>
                    </li>
                    ...
                    <li className="nav-item dropdown no-arrow">
                        <a className="nav-link dropdown-toggle" href="/other" id="userDropdown" role="button"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                            ...
                            <a className="dropdown-item" href="/other" data-toggle="modal" data-target="/otherlogoutModal">
                            ...
                            <div className="card-body">
                                <div className="dropdown no-arrow mb-4">
                                    ...
                                    <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a className="dropdown-item" href="/other">Another action</a>
